...
labels_csv = '/autofs/cluster/qtim/datasets/private/xray_drift/csv/labels_qwen.csv'
...
preprocessed_labels_csv = '/autofs/cluster/qtim/datasets/private/xray_drift/csv/labels_qwen.csv'
